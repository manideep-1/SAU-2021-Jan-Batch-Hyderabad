...
export default class tab2 extends Component {
    constructor() {
        ...
        async apicall(){
          let resp=await fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=2f5f4b92c5bf9a11b168797aa7a7491b&language=en-US&page=1')
    ...
    render() {
        ...
        return (
            ...
            <View>
                    <Text style={{fontSize:30, fontWeight:'500',textAlign:'center', backgroundColor: '#FF5733'}}>Top Rated</Text>
                </View>
            <FlatList
                data={d}
